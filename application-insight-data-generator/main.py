...
def generate_web_request():
    ...
    response_time = round(random.uniform(0.1, 3.0), 2)  # Simulate response times

    with tracer.start_as_current_span("simulated_request") as span:
...
if __name__ == "__main__":
    ...
    for _ in range(10):  # Generate 10 test requests
